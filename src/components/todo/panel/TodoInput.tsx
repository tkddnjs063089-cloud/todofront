...
export default function TodoInput({ onAdd, placeholder = "할 일을 입력하세요..." }: TodoInputProps) {
  ...
  return (
    <div className="flex gap-2">
      <input type="text" value={inputValue} onChange={(e) => setInputValue(e.target.value)} onKeyPress={handleKeyPress} placeholder={placeholder}
      ...
      <button onClick={handleAdd} className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-3 rounded-xl transition-all hover:scale-105 active:scale-95 shadow-lg">
